...
class Table:
    ...
    def move_buttons_post_blinds(self) -> tuple[int, int, int]:
        ...
        def _first_hand() -> tuple[int, int, int]:
            ...
            dealer_player = self.tables[dealer_button]

            if self.is_headsup():
                big_blind_button = present_seats[(dealer_idx + 1) % 2]
                bb_player = self.tables[big_blind_button]
            ...
            sb_player, bb_player = self.tables[small_blind_button], self.tables[big_blind_button]
